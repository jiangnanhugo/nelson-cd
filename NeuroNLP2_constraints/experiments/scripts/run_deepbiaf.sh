#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -u parsing.py --mode train --config configs/parsing/biaffine.json --num_epochs 50 --batch_size 32 \
