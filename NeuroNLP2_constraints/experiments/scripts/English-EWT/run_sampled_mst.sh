#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -u parsing.py --mode train --config configs/parsing/sampledmst.json --num_epochs 100 --batch_size 32 \
 ...
 --const_file "/home/jiangnanhugo/PycharmProjects/wilson/dataset/UD_English-EWT/dependency.json"\
